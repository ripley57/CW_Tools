# Description:
#	More complex map reduce demo from Chapter 05 (Listing 5.9) of Mastering Large Datasets.
#
# Given a large dictionary of car data:
# 1. We'll use map to clean-up the data and select just the data we need.
# 2. We'll use reduce to transform our data into the final answer.
#
# To run:
#	python3 demo2.py
