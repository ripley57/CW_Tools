...
Sub Usage
	...
	Wscript.Echo "   filetimes.vbs"
	Wscript.Echo ""
    Wscript.Echo "Description:"
	Wscript.Echo "   Display file time properties"
	Wscript.Echo ""
	Wscript.Echo "Comments:"
	Wscript.Echo "   Note: This program will not work with UNC paths"
	Wscript.Echo ""
	Wscript.Echo "Example"
	Wscript.Echo "   cscript filetimes.vbs d:\test\file.txt"
	Wscript.Echo ""
	Wscript.Echo "Name:          d:\test\file.txt"
...
If oFiles.Count < 1 Then
	Wscript.Echo "Could not find file. Please specify full file path."
Else
