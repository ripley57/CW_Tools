...
class GroovyClosureSpec extends spock.lang.Specification{
	...
	def "Testing Jpeg files"() {
		...
		//
		// All elements in the "result" list are checked automatically by the closure!
		//
		// Other useful methods like "every()":
		//	any	-	true is at leat one element satisfies the closure.
		//	find	-	Finds the first elements that satisfies the closure.
		//	findALl	-	Finds all ements that satisfy the closure.
		//
		// More details: http://www.groovy-lang.org/gdk.html
		//
