...
class ExceptionControlSpec extends spock.lang.Specification{
	...
	def "Error conditions for unknown products - better"() {
		...
		then: "an exception should be thrown"
		// Here we you examine the built-in message property that’s present
		// in all Java exceptions, but you could examine any property of a
		// custom-made exception instead:
