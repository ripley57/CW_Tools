...
class HelperMethodsSpec extends spock.lang.Specification{
	...
	// Lots of content in the setup code makes the test difficult to read.
	...
	// Better version of above test, using a helper method to make the test more readable.
	...
	// Same as above, but notice how use of variable names gets across
	// useful information regarding the test arguments.
