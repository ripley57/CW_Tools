...
class HelperMethodsAssertSpec extends spock.lang.Specification{
	...
	def "Normal approval for a loan - improved"() {
		...
		then: "loan is approved as is"
		// Descriptive helper method helps readability.
	...
	// Helper method. Note that recommendation is to make these void, and not return a boolean.
	// Notice also how "assert" needs to be used for code outside of "with()". Without this, the
	// statement will never cause the test to fail!!!
