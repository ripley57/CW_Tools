...
java com.teneo.esa.common.containerfile.analyzer.CCAnalyzer "RETRIEVE"  "D:\Test_Data\Non_RTF_Demo_7\Document.docx" "CASCADES_FIX1" "300" "0" "D:\outdir7" "4" "CWEmbed2.docx"
