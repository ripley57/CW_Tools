...
'
Function private_createshortcut(sDestDirSpecial, sDestDir2, sLinkName, sSourcePath, sDescription)
...
Function public_createshortcut()
	Dim sDestDirSpecial, sDestDir2, sLinkName, sDescription, sTarget
	...
	private_createshortcut sDestDirSpecial, sDestDir2, sLinkName, sTarget, sDescription
End Function
