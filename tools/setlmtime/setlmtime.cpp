/*
** Program to set file last modified time to a CW sentdatetime value.
**
** JeremyC Nov 2013.
*/
...
void usage(const char* progname)
{
	_tprintf(	_T("\n")
				_T("%s\n\n")
				_T("Description:\n")
				_T("  Set file time using sentdatetime value.\n\n")
				_T("Usage:\n")
				_T("  %s sentdatetime filename\n\n") 
				_T("Example:\n")
				_T("  %s 1374434628000 test.pdf\n\n"),
...
void main(int argc, char** argv) {
	...
	hFile = CreateFile(argv[2], GENERIC_READ | GENERIC_WRITE, FILE_SHARE_READ, 
