...
#	mp3edit.sh <mp3file> --list_title
#       mp3edit.sh <mp3file> [--title <string>] [--image <file>] [--album <string|FOLDER|TODAY>] [--artist <string|FOLDER|TODAY>]
...
Usage: 
	...
	$PROGNAME <mp3file> --list_title
	$PROGNAME <mp3file> [--title <string>] [--image <imagefile>] [--album <string|FOLDER|TODAY>] [--artist <string|FOLDER|TODAY>]
