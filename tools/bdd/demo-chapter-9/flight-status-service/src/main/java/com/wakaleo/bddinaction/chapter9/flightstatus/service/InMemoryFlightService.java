...
public class InMemoryFlightService implements FlightService {
	...
	// JeremyC 29-07-2019: Use of "Optional" class.
	// Note how this makes the code more readable; the calling
	// side doesn't need to check for null and then also assume 
	// what this means.
	// See https://www.tutorialspoint.com/guava/guava_optional_class
	...
	// JeremyC 29-07-2019: NOTE: use of filter()
	// I think this code was written before Java 1.8, because it looks like "filter()"
        // became part of "streams" in Java 8, see https://www.mkyong.com/java8/java-8-streams-filter-examples/
